package com.ibm.internalapp.approvereject;
...
public class TestUtils {
    ...
    static {
		...
		/*
		 * dynamodbEventMapper.addMixIn(Record.class,
		 * DynamodbEventMixin.RecordMixin.class);
		 * dynamodbEventMapper.addMixIn(StreamRecord.class,
		 * DynamodbEventMixin.StreamRecordMixin.class);
		 * dynamodbEventMapper.addMixIn(AttributeValue.class,
